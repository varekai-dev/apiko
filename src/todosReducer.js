...
export const TODOS_ACTIONS = { ADD: ' add', COMPLETE: ' complete', REMOVE: 'remove', EDIT: 'edit' }
...
export const todosReducer = (todos, action) => {
  ...
  switch (type) {
    ...
    case TODOS_ACTIONS.COMPLETE:
      return todos.map((todo) => (_id === todo._id ? { ...todo, completed: !todo.completed } : todo))
